...
const Switch = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SwitchPrimitives.Root> & { loading?: boolean; thumbClassName?: string }
>(({ className, loading, thumbClassName, ...props }, ref) => {
